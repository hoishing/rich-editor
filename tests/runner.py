...
from .test_editor_shortcuts import (
    ...
    test_indent_line_aliases,
    test_indent_selected_lines,
    test_insert_line_above_aliases,
    test_insert_line_below_aliases,
...
TESTS: list[tuple[str, Callable[[], Awaitable[None]]]] = [
    ...
    ("editor: insert line below aliases", test_insert_line_below_aliases),
    ("editor: insert line above aliases", test_insert_line_above_aliases),
    ("editor: indent line aliases", test_indent_line_aliases),
    ("editor: indent selected lines", test_indent_selected_lines),
    ("editor: outdent line aliases", test_outdent_line_aliases),
    (
        "editor: outdent selected lines removes up to two spaces",
        test_outdent_selected_lines_removes_up_to_two_spaces,
    ),
